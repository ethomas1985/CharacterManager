...
namespace Pathfinder.Model.Items
{
    internal class WeaponComponent : IWeaponComponent, IEquatable<IWeaponComponent>
    {
        ...
        public static WeaponComponent Copy(IWeaponComponent pOther)
        {
            return new WeaponComponent(pOther.Proficiency,
                                       pOther.WeaponType,
                                       pOther.Encumbrance,
                                       pOther.Size,
                                       pOther.DamageType,
                                       pOther.BaseWeaponDamage.Select(Dice.Copy).ToList(),
                                       pOther.CriticalThreat,
                                       pOther.CriticalMultiplier,
                                       pOther.Range,
                                       pOther.Specials);
        }
    }
