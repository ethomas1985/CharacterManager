...
namespace Pathfinder.Repository
{
    ...
    public class SpellMongoRepository : ISpellPersistenceStore
    {
        ...
        public SpellMongoRepository(IMongoSettings pSettings)
        {
            _store = new MongoRepository<Spell>(pSettings, "spells");
        }
        ...
        {
            var filter = new FilterDefinitionBuilder<Spell>()
                .Eq(nameof(Spell.Name), pValue.Name);
