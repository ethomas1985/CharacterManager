	...
	public class AbilityScoreTests
	{
		...
		public static class AbilityScoreTestCase
		{
			public static IEnumerable ModifierCases
			{
				...
				{
					// Ability Score = 1
					yield return new TestCaseData(1, 0, 0, 0, 0).Returns(-5).SetName("0 <= Score <= 1 := -5 Modifier");
					// 2 <= Ability Score <= 3
					yield return new TestCaseData(2, 0, 0, 0, 0).Returns(-4).SetName("1 <= Score <= 3 := -4 Modifier");
					// 4 <= Ability Score <= 5
					yield return new TestCaseData(4, 0, 0, 0, 0).Returns(-3).SetName("3 <= Score <= 5 := -3 Modifier");
					// 6 <= Ability Score <= 7
					yield return new TestCaseData(6, 0, 0, 0, 0).Returns(-2).SetName("5 <= Score <= 7 := -2 Modifier");
					// 8 <= Ability Score <= 9
					yield return new TestCaseData(8, 0, 0, 0, 0).Returns(-1).SetName("7 <= Score <= 9 := -1 Modifier");
					// 10 <= Ability Score <= 11
					yield return new TestCaseData(10, 0, 0, 0, 0).Returns(0).SetName("9 <= Score <= 11 := 0 Modifier");
					// 12 <= Ability Score <= 13
					yield return new TestCaseData(12, 0, 0, 0, 0).Returns(1).SetName("11 <= Score <= 13 := 1 Modifier");
					// 14 <= Ability Score <= 15
					yield return new TestCaseData(14, 0, 0, 0, 0).Returns(2).SetName("13 <= Score <= 15 := 2 Modifier");
					// 16 <= Ability Score <= 17
					yield return new TestCaseData(16, 0, 0, 0, 0).Returns(3).SetName("15 <= Score <= 17 := 3 Modifier");
					// 18 <= Ability Score <= 19
					yield return new TestCaseData(18, 0, 0, 0, 0).Returns(4).SetName("17 <= Score <= 19 := 4 Modifier");
				}
			}
